  ...
  try {
      ...
      newContent.innerHTML = `
        <ul class="filter-list">
          ...
          <li class="filter-item">
            <button project-filter-btn>Web design</button>
          </li>
          <li class="filter-item">
            <button project-filter-btn>Applications</button>
          </li>
          <li class="filter-item">
            <button project-filter-btn>Web development</button>
          </li>
        </ul>
  ...
  const projectFilterFunc = function (selectedValue) {
      projectFilterItems.forEach(item => {
          if (selectedValue === "all") {
              ...
              item.style.display = 'block'; // Show items with selected category
          } else {
